...
#define ITER     10000
#define SMIN     10          // cluster minimo a analizar
#define SMAX     170         // cluster maximo a analizar
...
{ 
  ...
  { 
    ...
    Porcentaje=100*(p-0.55)/0.55;

    printf("Total:\t%f /100 \r", Porcentaje);
	fflush(stdout);
